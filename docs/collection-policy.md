...
`services.collector.import_sheet` importa a aba Página2 pelo endpoint CSV, preserva domínios normalizados, marca URLs irrecuperáveis como `invalid_url` e não ativa fontes novas.
